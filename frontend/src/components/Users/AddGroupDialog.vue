  ...
  >
    <el-form>
      <el-form-item label="Groupe">
        <el-select v-model="selectedGroupLocal" placeholder="Sélectionner un groupe" style="width: 100%">
          <el-option
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button type="primary" @click="addGroup" :disabled="!selectedGroupLocal">
          Ajouter
        </el-button>
      </span>
    </template>
...
const selectedGroupLocal = ref<number | null>(props.selectedGroup)

// Watch for changes in the selectedGroup prop
watch(() => props.selectedGroup, (newValue) => {
  selectedGroupLocal.value = newValue
})
