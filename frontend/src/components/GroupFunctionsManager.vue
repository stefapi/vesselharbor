...
<template>
  <div class="u-border u-border-gray-300 u-p-4 u-mt-4 u-rounded">
    ...
    <ul class="u-space-y-2 u-mb-6">
      <li
        v-for="func in groupFunctions"
        :key="func.id"
        class="u-flex u-justify-between u-items-center u-p-2 u-bg-gray-50 u-rounded"
      >
      ...
      <li v-if="groupFunctions.length === 0" class="u-text-gray-500 u-italic">
    ...
    <div class="u-space-y-3">
      ...
      <div class="u-flex u-gap-2">
        <select
          ...
          class="u-flex-1 u-px-3 u-py-2 u-border u-border-gray-300 u-rounded u-focus:outline-none u-focus:ring-2 u-focus:ring-blue-500"
        >
        ...
        <button
          ...
          class="u-px-4 u-py-2 u-bg-blue-500 u-text-white u-rounded u-hover:bg-blue-600 u-disabled:opacity-50 u-disabled:cursor-not-allowed"
        >
          Ajouter
        </button>
      </div>
